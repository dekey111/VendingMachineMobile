...
namespace VendingMachineMobile
{
    ...
    {
        public const string DATABASE_NAME = "VendingMachineMobile.db";
        public static DrinksRepository database;
        public static DrinksRepository Database
        {
            get
            {
                if (database == null)
                {
                    ...
                    if (!File.Exists(dbPath))
                    {
                        ...
                        using (Stream stream = assembly.GetManifestResourceStream($"VendingMachineMobile.{DATABASE_NAME}"))
                        {
                    ...
                    database = new DrinksRepository(dbPath);
                }
                return database;
            }
        }
